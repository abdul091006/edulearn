  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-purple-100 p-12 text-center">
      <div className="max-w-md mx-auto">
        ...
        <h3 className="text-2xl font-bold text-purple-900 mb-3">No Assignments Found</h3>
        <p className="text-purple-600 mb-8">
          You don't have any assignments yet, or they don't match your current filters. Try adjusting your search
